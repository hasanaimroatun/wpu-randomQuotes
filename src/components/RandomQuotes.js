...
import TombolRandomQuotes from './TombolRandomQuotes'
import TombolSemuaQuotes from './TombolSemuaQuotes'
...
function RandomQuotes() {
  ...
  return (
    <div>
        <TombolRandomQuotes handleClick={handleClick}/>
        ...
        <TombolSemuaQuotes handleClick2={handleClick2} author={author} genre={genre} styleTombol={styleTombol} stylePenulis2={stylePenulis2} handleMouseEnter={handleMouseEnter} handleMouseLeave={handleMouseLeave}/>
        <CreatedBy />
    </div>
  )
}
